  ...
  <body class="font-Poppins">
    ...
    <header>
      <nav class="container flex items-center py-4 mt-4 sm:mt-12">
        <div class="py-1"><img src="logo-bookmark.svg" alt="" /></div>
        <ul class="hidden sm:flex flex-1 justify-end items-center gap-12 text-bookmark-blue uppercase text-xs">
          ...
          <button type="button" class="bg-bookmark-red text-white rounded-md px-7 py-3 uppercase">
            ...
            if (isset($_SESSION['user_name'])) {
                ...
                echo $username . '\'s </span>';
                echo '<a href="profile.php" class="profile-btn"> Profile</a>';
            }
            ?>
        </div>
      </button>
    ...
    <section class="relative">
      <div class="container flex flex-col-reverse lg:flex-row items-center gap-12 mt-14 lg:mt-28">
        ...
        <div class="flex justify-center flex-1 mb-10 md:mb-16 lg:mb-0 z-10">
          <img class="w-5/6 h-5/6 sm:w-3/4 sm:h-3/4 md:w-full md:h-full" src="hero-bg.png" alt="" />
        </div>
      </div>
      <!-- Rounded Rectangle -->
      <div
